...
from PyQt5.QtWidgets import QApplication, QWidget, QPushButton, QInputDialog, QLineEdit, QFileDialog# If PyQt4 is not working in your case, you can try PyQt5, 
import json
seed = 7
np.random.seed(seed)
...
class PrettyWidget(QWidget):
    ...
    def initUI(self):
        ...
        btn = QPushButton('ANOMALY DETECTION SYSTEM \n Start', self)

        Model_dir = r'C:\Users\SNEHA\Downloads\AnomalyDetectionCVPR2018-master\AnomalyDetectionCVPR2018-master'
    ...
    def SingleBrowse(self):
        ...
        video_path = r'C:/Users/SNEHA/Downloads/AnomalyDetectionCVPR2018-master/AnomalyDetectionCVPR2018-master/SampleVideos/Normal_Videos_006_x264.mp4'
        print(video_path)
        ...
        np.savetxt("pred.txt",predictions,delimiter=' ',newline=' ')
        Frames_Score = []
        count = -1;
